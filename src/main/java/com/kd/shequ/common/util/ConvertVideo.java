package com.kd.shequ.common.util;
...
//            inputPath = "D:\\CloudMusic\\MV\\1.mp4";
            inputPath = "D:\\ftest\\a.flv";
            outputPath = "D:\\ftest\\";
            ffmpegPath = "D:\\worktools\\ffmpeg-20180908\\bin\\";
...
//        status = processFlv(inputPath);// 直接转成mp4格式
        return status;
    }
...
//                    + outputPath + "a.flv");
    ...
    private static boolean processMp4(String oldfilepath) {
        ...
        command.add(outputPath + "123.mp4");
        try {
